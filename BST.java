...
public class BST<T> {
	...
	public T getRoot() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("getRoot: " + "Cannot getRoot, Tree is empty");
		}
		return root.data;
	}
	...
	public T findMin() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMin: " + "Cannot findMin, Tree is empty");
		}
		return findMin(root);
	}
	...
	public T findMax() throws NoSuchElementException {
		if (isEmpty()) {
			throw new NoSuchElementException("findMax: " + "Cannot findMax, Tree is empty");
		}
		return findMax(root);
	}
